                   ...
                   @endphp
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            ...
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ $photo }}" data-gall="myGallery">
                        ...
                        <div class="product-details-thumbs slider-thumbs-1">    
                            @foreach($photos as $key => $photo)                                    
                                <div class="sm-image"><img src="{{ $photo }}" alt="{{ $product->title }}"></div>
                            @endforeach
                        </div>
                    </div>
                    <!--// Product Details Left -->
                            ...
                            <div class="col-lg-12">
                                ...
                                @endphp
                                    <div class="product-image">
                                        ...
                                        <span class="sticker">{{ $item->conditions }}</span>
                                    </div>
                                        ...
                                        <div class="product_desc_info">
                                            <div class="product-review">
                                                <h5 class="manufacturer">
                                                    @php
                                                        $brand = \App\Models\Brand::where('id',$item->brand_id)->value('title');
                                                    @endphp
                                                    <a href="{{ route('product.details',$item->slug) }}">{{ $brand }}</a>
                                                </h5>
                                            ...
                                            <div class="price-box">
                                                <span class="new-price">{{ number_format($item->offer_price,2) }}</span>
                                            </div>
                                        </div>
