...
@include('frontend.components.slider-with-banner')
@include('frontend.components.static-banner')
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            @php
                $new = \App\Models\Product::where(['status'=>'active','conditions'=>'new'])->orderBy('id','DESC')->limit(10)->get();
            @endphp
            @if (count($new) > 0)
